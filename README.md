...
| Объём кода ≤ 10 МБ | **≈2 МиБ** всего, из них ~1.4 МиБ — ленивый чанк libheif, который скачивается только при обработке HEIC. CI-гейт на 8 МиБ (`scripts/size-budget-check.mjs`) |
